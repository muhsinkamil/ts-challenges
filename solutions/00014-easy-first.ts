// Question: https://github.com/type-challenges/type-challenges/tree/main/questions/00014-easy-first
...
type First<T extends unknown[]> = T extends [infer Head, ...infer Tail]
  ? Head
  : never;
